          ...
          <div className="grid gap-6 py-4">
            <RadioGroup value={actionType} onValueChange={(v) => setActionType(v as any)} className="grid grid-cols-2 gap-4 lg:grid-cols-3">
              <div>
                ...
                <Label htmlFor="i-reschedule" className={`flex h-full cursor-pointer flex-col items-center justify-between border-2 border-muted bg-popover p-4 hover:bg-accent hover:text-accent-foreground peer-data-[state=checked]:border-blue-600 peer-data-[state=checked]:text-blue-600 ${radiusClass}`}>
              ...
              {(selectedSession?.type === "online" || selectedSession?.type === "hybrid") && (
                <div>
                  ...
                  <Label htmlFor="i-link" className={`flex h-full cursor-pointer flex-col items-center justify-between border-2 border-muted bg-popover p-4 text-center hover:bg-blue-50 hover:text-blue-900 peer-data-[state=checked]:border-blue-600 peer-data-[state=checked]:text-blue-600 ${radiusClass}`}>
              ...
              <div>
                ...
                <Label htmlFor="i-cancel" className={`flex h-full cursor-pointer flex-col items-center justify-between border-2 border-muted bg-popover p-4 hover:bg-red-50 hover:text-red-900 peer-data-[state=checked]:border-red-600 peer-data-[state=checked]:text-red-600 ${radiusClass}`}>
